...
addForm.addEventListener("submit", (e) => {
  e.preventDefault();
  // We implement this line of code to prevent the form from behaving in the default manner by trying to sumbit to a file or something that usually causes the form to reload. Nobody wants that.
  ...
  const makeHumus = (factor) => {
    const ingredient = (amount, unit, name) => {
      ...
      if (!numberOfText || numberOfText == NaN) {
        ...
        divMessage.innerHTML = `<b>To make ${numberOfText} Doughnut(s), you need:</b>`
